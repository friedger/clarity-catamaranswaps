...
arkadikoDao: {
  "functions": {
    burnToken: {"name":"burn-token","access":"public","args":[{"name":"token","type":"trait_reference"},{"name":"amount","type":"uint128"},{"name":"recipient","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[token: TypedAbiArg<string, "token">, amount: TypedAbiArg<number | bigint, "amount">, recipient: TypedAbiArg<string, "recipient">], Response<boolean, bigint>>,
    mintToken: {"name":"mint-token","access":"public","args":[{"name":"token","type":"trait_reference"},{"name":"amount","type":"uint128"},{"name":"recipient","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[token: TypedAbiArg<string, "token">, amount: TypedAbiArg<number | bigint, "amount">, recipient: TypedAbiArg<string, "recipient">], Response<boolean, bigint>>,
    requestDikoTokens: {"name":"request-diko-tokens","access":"public","args":[{"name":"collateral-amount","type":"uint128"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[collateralAmount: TypedAbiArg<number | bigint, "collateralAmount">], Response<boolean, bigint>>,
    setContractAddress: {"name":"set-contract-address","access":"public","args":[{"name":"name","type":{"string-ascii":{"length":256}}},{"name":"address","type":"principal"},{"name":"qualified-name","type":"principal"},{"name":"can-mint","type":"bool"},{"name":"can-burn","type":"bool"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[name: TypedAbiArg<string, "name">, address: TypedAbiArg<string, "address">, qualifiedName: TypedAbiArg<string, "qualifiedName">, canMint: TypedAbiArg<boolean, "canMint">, canBurn: TypedAbiArg<boolean, "canBurn">], Response<boolean, bigint>>,
    setDaoOwner: {"name":"set-dao-owner","access":"public","args":[{"name":"address","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[address: TypedAbiArg<string, "address">], Response<boolean, bigint>>,
    setGuardianAddress: {"name":"set-guardian-address","access":"public","args":[{"name":"address","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[address: TypedAbiArg<string, "address">], Response<boolean, bigint>>,
    setPayoutAddress: {"name":"set-payout-address","access":"public","args":[{"name":"address","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[address: TypedAbiArg<string, "address">], Response<boolean, bigint>>,
    toggleEmergencyShutdown: {"name":"toggle-emergency-shutdown","access":"public","args":[],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[], Response<boolean, bigint>>,
    getContractAddressByName: {"name":"get-contract-address-by-name","access":"read_only","args":[{"name":"name","type":{"string-ascii":{"length":256}}}],"outputs":{"type":{"optional":"principal"}}} as TypedAbiFunction<[name: TypedAbiArg<string, "name">], string | null>,
    getContractCanBurnByQualifiedName: {"name":"get-contract-can-burn-by-qualified-name","access":"read_only","args":[{"name":"qualified-name","type":"principal"}],"outputs":{"type":"bool"}} as TypedAbiFunction<[qualifiedName: TypedAbiArg<string, "qualifiedName">], boolean>,
    getContractCanMintByQualifiedName: {"name":"get-contract-can-mint-by-qualified-name","access":"read_only","args":[{"name":"qualified-name","type":"principal"}],"outputs":{"type":"bool"}} as TypedAbiFunction<[qualifiedName: TypedAbiArg<string, "qualifiedName">], boolean>,
    getDaoOwner: {"name":"get-dao-owner","access":"read_only","args":[],"outputs":{"type":"principal"}} as TypedAbiFunction<[], string>,
    getEmergencyShutdownActivated: {"name":"get-emergency-shutdown-activated","access":"read_only","args":[],"outputs":{"type":{"response":{"ok":"bool","error":"none"}}}} as TypedAbiFunction<[], Response<boolean, null>>,
    getGuardianAddress: {"name":"get-guardian-address","access":"read_only","args":[],"outputs":{"type":"principal"}} as TypedAbiFunction<[], string>,
    getPayoutAddress: {"name":"get-payout-address","access":"read_only","args":[],"outputs":{"type":"principal"}} as TypedAbiFunction<[], string>,
    getQualifiedNameByName: {"name":"get-qualified-name-by-name","access":"read_only","args":[{"name":"name","type":{"string-ascii":{"length":256}}}],"outputs":{"type":{"optional":"principal"}}} as TypedAbiFunction<[name: TypedAbiArg<string, "name">], string | null>
  },
  "maps": {
    contracts: {"name":"contracts","key":{"tuple":[{"name":"name","type":{"string-ascii":{"length":256}}}]},"value":{"tuple":[{"name":"address","type":"principal"},{"name":"qualified-name","type":"principal"}]}} as TypedAbiMap<{
  "name": string;
}, {
  "address": string;
  "qualifiedName": string;
}>,
    contractsData: {"name":"contracts-data","key":{"tuple":[{"name":"qualified-name","type":"principal"}]},"value":{"tuple":[{"name":"can-burn","type":"bool"},{"name":"can-mint","type":"bool"}]}} as TypedAbiMap<{
  "qualifiedName": string;
}, {
  "canBurn": boolean;
  "canMint": boolean;
...
arkadikoToken: {
  "functions": {
    ...
    burnForDao: {"name":"burn-for-dao","access":"public","args":[{"name":"amount","type":"uint128"},{"name":"sender","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[amount: TypedAbiArg<number | bigint, "amount">, sender: TypedAbiArg<string, "sender">], Response<boolean, bigint>>,
    mintForDao: {"name":"mint-for-dao","access":"public","args":[{"name":"amount","type":"uint128"},{"name":"recipient","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[amount: TypedAbiArg<number | bigint, "amount">, recipient: TypedAbiArg<string, "recipient">], Response<boolean, bigint>>,
    ...
    getDecimals: {"name":"get-decimals","access":"read_only","args":[],"outputs":{"type":{"response":{"ok":"uint128","error":"none"}}}} as TypedAbiFunction<[], Response<bigint, null>>,
    getName: {"name":"get-name","access":"read_only","args":[],"outputs":{"type":{"response":{"ok":{"string-ascii":{"length":14}},"error":"none"}}}} as TypedAbiFunction<[], Response<string, null>>,
  ...
  "fungible_tokens":[{"name":"diko"}],"epoch":"Epoch21","clarity_version":"Clarity1",
...
btcStxSwap: {
  ...
  "pubscriptkey": Uint8Array;
    ...
    cancel: {"name":"cancel","access":"public","args":[{"name":"id","type":"uint128"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[id: TypedAbiArg<number | bigint, "id">], Response<boolean, bigint>>,
    createSwap: {"name":"create-swap","access":"public","args":[{"name":"sats","type":"uint128"},{"name":"btc-receiver","type":{"buffer":{"length":40}}},{"name":"ustx","type":"uint128"},{"name":"stx-receiver","type":{"optional":"principal"}},{"name":"premium","type":"uint128"}],"outputs":{"type":{"response":{"ok":"uint128","error":"uint128"}}}} as TypedAbiFunction<[sats: TypedAbiArg<number | bigint, "sats">, btcReceiver: TypedAbiArg<Uint8Array, "btcReceiver">, ustx: TypedAbiArg<number | bigint, "ustx">, stxReceiver: TypedAbiArg<string | null, "stxReceiver">, premium: TypedAbiArg<number | bigint, "premium">], Response<bigint, bigint>>,
    getOutValue: {"name":"get-out-value","access":"public","args":[{"name":"tx","type":{"tuple":[{"name":"ins","type":{"list":{"type":{"tuple":[{"name":"outpoint","type":{"tuple":[{"name":"hash","type":{"buffer":{"length":32}}},{"name":"index","type":{"buffer":{"length":4}}}]}},{"name":"scriptSig","type":{"buffer":{"length":256}}},{"name":"sequence","type":{"buffer":{"length":4}}}]},"length":8}}},{"name":"locktime","type":{"buffer":{"length":4}}},{"name":"outs","type":{"list":{"type":{"tuple":[{"name":"scriptPubKey","type":{"buffer":{"length":128}}},{"name":"value","type":{"buffer":{"length":8}}}]},"length":8}}},{"name":"version","type":{"buffer":{"length":4}}}]}},{"name":"pubscriptkey","type":{"buffer":{"length":40}}}],"outputs":{"type":{"response":{"ok":{"tuple":[{"name":"out","type":{"optional":{"tuple":[{"name":"scriptPubKey","type":{"buffer":{"length":128}}},{"name":"value","type":"uint128"}]}}},{"name":"pubscriptkey","type":{"buffer":{"length":40}}}]},"error":"none"}}}} as TypedAbiFunction<[tx: TypedAbiArg<{
  "ins": {
  "outpoint": {
  "hash": Uint8Array;
  ...
  "pubscriptkey": Uint8Array;
    ...
    setStxReceiver: {"name":"set-stx-receiver","access":"public","args":[{"name":"id","type":"uint128"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[id: TypedAbiArg<number | bigint, "id">], Response<boolean, bigint>>,
    submitSwap: {"name":"submit-swap","access":"public","args":[{"name":"id","type":"uint128"},{"name":"height","type":"uint128"},{"name":"blockheader","type":{"buffer":{"length":32}}},{"name":"tx","type":{"tuple":[{"name":"ins","type":{"list":{"type":{"tuple":[{"name":"outpoint","type":{"tuple":[{"name":"hash","type":{"buffer":{"length":32}}},{"name":"index","type":{"buffer":{"length":4}}}]}},{"name":"scriptSig","type":{"buffer":{"length":256}}},{"name":"sequence","type":{"buffer":{"length":4}}}]},"length":8}}},{"name":"locktime","type":{"buffer":{"length":4}}},{"name":"outs","type":{"list":{"type":{"tuple":[{"name":"scriptPubKey","type":{"buffer":{"length":128}}},{"name":"value","type":{"buffer":{"length":8}}}]},"length":8}}},{"name":"version","type":{"buffer":{"length":4}}}]}},{"name":"proof","type":{"tuple":[{"name":"hashes","type":{"list":{"type":{"buffer":{"length":32}},"length":12}}},{"name":"tree-depth","type":"uint128"},{"name":"tx-index","type":"uint128"}]}}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[id: TypedAbiArg<number | bigint, "id">, height: TypedAbiArg<number | bigint, "height">, blockheader: TypedAbiArg<Uint8Array, "blockheader">, tx: TypedAbiArg<{
  "ins": {
  "outpoint": {
  "hash": Uint8Array;
  "index": Uint8Array;
  ...
  "maps": {
    submittedBtcTxs: {"name":"submitted-btc-txs","key":{"buffer":{"length":128}},"value":"uint128"} as TypedAbiMap<Uint8Array, bigint>,
    swaps: {"name":"swaps","key":"uint128","value":{"tuple":[{"name":"btc-receiver","type":{"buffer":{"length":40}}},{"name":"done","type":"bool"},{"name":"premium","type":"uint128"},{"name":"sats","type":"uint128"},{"name":"stx-receiver","type":{"optional":"principal"}},{"name":"stx-sender","type":"principal"},{"name":"ustx","type":"uint128"},{"name":"when","type":"uint128"}]}} as TypedAbiMap<number | bigint, {
  "btcReceiver": Uint8Array;
  "done": boolean;
  "premium": bigint;
  "sats": bigint;
...
initSbtc: {
  "functions": {
    getBurnHeight: {"name":"get-burn-height","access":"read_only","args":[],"outputs":{"type":"uint128"}} as TypedAbiFunction<[], bigint>
  },
  "maps": {
...
usdaToken: {
  "functions": {
    burn: {"name":"burn","access":"public","args":[{"name":"amount","type":"uint128"},{"name":"sender","type":"principal"}],"outputs":{"type":{"response":{"ok":"none","error":"uint128"}}}} as TypedAbiFunction<[amount: TypedAbiArg<number | bigint, "amount">, sender: TypedAbiArg<string, "sender">], Response<null, bigint>>,
    burnForDao: {"name":"burn-for-dao","access":"public","args":[{"name":"amount","type":"uint128"},{"name":"sender","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[amount: TypedAbiArg<number | bigint, "amount">, sender: TypedAbiArg<string, "sender">], Response<boolean, bigint>>,
    mintForDao: {"name":"mint-for-dao","access":"public","args":[{"name":"amount","type":"uint128"},{"name":"recipient","type":"principal"}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[amount: TypedAbiArg<number | bigint, "amount">, recipient: TypedAbiArg<string, "recipient">], Response<boolean, bigint>>,
    setTokenUri: {"name":"set-token-uri","access":"public","args":[{"name":"value","type":{"string-utf8":{"length":256}}}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[value: TypedAbiArg<string, "value">], Response<boolean, bigint>>,
    transfer: {"name":"transfer","access":"public","args":[{"name":"amount","type":"uint128"},{"name":"sender","type":"principal"},{"name":"recipient","type":"principal"},{"name":"memo","type":{"optional":{"buffer":{"length":34}}}}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[amount: TypedAbiArg<number | bigint, "amount">, sender: TypedAbiArg<string, "sender">, recipient: TypedAbiArg<string, "recipient">, memo: TypedAbiArg<Uint8Array | null, "memo">], Response<boolean, bigint>>,
    getBalance: {"name":"get-balance","access":"read_only","args":[{"name":"account","type":"principal"}],"outputs":{"type":{"response":{"ok":"uint128","error":"none"}}}} as TypedAbiFunction<[account: TypedAbiArg<string, "account">], Response<bigint, null>>,
    getDecimals: {"name":"get-decimals","access":"read_only","args":[],"outputs":{"type":{"response":{"ok":"uint128","error":"none"}}}} as TypedAbiFunction<[], Response<bigint, null>>,
    getName: {"name":"get-name","access":"read_only","args":[],"outputs":{"type":{"response":{"ok":{"string-ascii":{"length":4}},"error":"none"}}}} as TypedAbiFunction<[], Response<string, null>>,
    getSymbol: {"name":"get-symbol","access":"read_only","args":[],"outputs":{"type":{"response":{"ok":{"string-ascii":{"length":4}},"error":"none"}}}} as TypedAbiFunction<[], Response<string, null>>,
    getTokenUri: {"name":"get-token-uri","access":"read_only","args":[],"outputs":{"type":{"response":{"ok":{"optional":{"string-utf8":{"length":256}}},"error":"none"}}}} as TypedAbiFunction<[], Response<string | null, null>>,
    getTotalSupply: {"name":"get-total-supply","access":"read_only","args":[],"outputs":{"type":{"response":{"ok":"uint128","error":"none"}}}} as TypedAbiFunction<[], Response<bigint, null>>
  },
  ...
  "fungible_tokens":[{"name":"usda"}],"epoch":"Epoch21","clarity_version":"Clarity1",
...
export const identifiers = {"wrappedBitcoin":"SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin","arkadikoDao":"SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-dao","arkadikoDaoTokenTraitV1":"SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-dao-token-trait-v1","arkadikoToken":"SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-token","btcSbtcSwap":"ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.btc-sbtc-swap","btcStxSwap":"ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.btc-stx-swap","clarityBitcoinHelper":"SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.clarity-bitcoin-helper","clarityBitcoinHelperWtx":"ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.clarity-bitcoin-helper-wtx","clarityBitcoinLibV5":"SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.clarity-bitcoin-lib-v5","ftTrait":"SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.ft-trait","initSbtc":"ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.init-sbtc","restrictedTokenTrait":"SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.restricted-token-trait","sbtcBootstrapSigners":"SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-bootstrap-signers","sbtcDeposit":"SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-deposit","sbtcRegistry":"SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-registry","sbtcToken":"SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token","sbtcWithdrawal":"SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-withdrawal","sip010TraitFtStandard":"SP3FBR2AGK5H9QBDH3EEN6DF8EK8JY7RX8QJ5SVTE.sip-010-trait-ft-standard","usdaToken":"SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.usda-token"} as const
