...
(define-constant ERR_BTC_RECEIVER_IN_USE (err u10))
...
;; map between btc receiver and swap id
(define-map active-btc-receivers (buff 40) uint)
...
(define-public (create-swap (sats uint) (btc-receiver (buff 40)) (amount uint) (stx-receiver (optional principal)) (premium uint))
  (let ((id (var-get next-id)))
    (asserts! (map-insert active-btc-receivers btc-receiver id) ERR_BTC_RECEIVER_IN_USE)
